import{_ as p,Q as v,S as m,$ as e,U as n,a0 as a,a1 as s,a2 as t,D as i}from"./framework-137012f8.js";const b={},g=n("h1",{id:"markdown",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#markdown","aria-hidden":"true"},"#"),s(" Markdown")],-1),k=n("h2",{id:"自定义容器",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#自定义容器","aria-hidden":"true"},"#"),s(" 自定义容器")],-1),h=t(`<p>使用：</p><div class="language-markdown line-numbers-mode" data-ext="md"><pre class="language-markdown"><code>::: <span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>type</span><span class="token punctuation">&gt;</span></span> [title]
[content]
:::
...
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1);function O(V,T){const d=i("NpmBadge"),l=i("RouterLink"),c=i("CodeTabs");return v(),m("div",null,[g,e(d,{package:"@vuepress/theme-default"}),k,n("ul",null,[n("li",null,[h,n("ul",null,[_,f,w,y,n("li",null,[e(l,{to:"/zh/reference/default-theme/components.html#codegroup"},{default:a(()=>[s("CodeGroup")]),_:1}),s(" 和 "),e(l,{to:"/zh/reference/default-theme/components.html#codegroupitem"},{default:a(()=>[s("CodeGroupItem")]),_:1}),s(" 的别名： "),x])])]),q]),B,e(c,{id:"129",data:[{title:"FOO"},{title:"BAR"}]},{tab0:a(({title:o,value:r,isActive:u})=>[C]),tab1:a(({title:o,value:r,isActive:u})=>[N]),_:1})])}const P=p(b,[["render",O],["__file","markdown.html.vue"]]);export{P as default};
