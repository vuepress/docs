import{_ as c}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as p,o as l,c as r,a as n,b as s,d as a,w as o,e}from"./app-fcUJjNM4.js";const d={},u=e(`<h1 id="多语言支持" tabindex="-1"><a class="header-anchor" href="#多语言支持"><span>多语言支持</span></a></h1><h2 id="站点多语言配置" tabindex="-1"><a class="header-anchor" href="#站点多语言配置"><span>站点多语言配置</span></a></h2><p>要启用 VuePress 的多语言支持，首先需要使用如下的文件目录结构：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>docs
├─ README.md
├─ foo.md
├─ nested
│  └─ README.md
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),g={class:"hint-container tip"},_=n("p",{class:"hint-container-title"},"提示",-1),f={href:"https://ecosystem.vuejs.press/zh/themes/default/config.html#locales",target:"_blank",rel:"noopener noreferrer"};function y(x,E){const t=p("RouterLink"),i=p("ExternalLinkIcon");return l(),r("div",null,[u,n("p",null,[s("然后，在你的 "),a(t,{to:"/zh/guide/configuration.html#%E9%85%8D%E7%BD%AE%E6%96%87%E4%BB%B6"},{default:o(()=>[s("配置文件")]),_:1}),s(" 中设置 "),v,s(" 选项：")]),k,n("div",m,[h,n("p",null,[s("配置参考： "),a(t,{to:"/zh/reference/config.html#locales"},{default:o(()=>[s("locales")]),_:1})])]),b,n("div",g,[_,n("p",null,[s("配置参考： "),n("a",f,[s("默认主题 > locales"),a(i)])])])])}const z=c(d,[["render",y],["__file","i18n.html.vue"]]);export{z as default};
