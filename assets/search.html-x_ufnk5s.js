import{_ as o}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as t,o as r,c as u,d as a,a as n,b as s,w as i,e}from"./app-Vtomtg5h.js";const d={},v=n("h1",{id:"search",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#search","aria-hidden":"true"},"#"),s(" search")],-1),k=e(`<p>为你的文档网站提供本地搜索能力。</p><div class="hint-container tip"><p class="hint-container-title">提示</p><p>当你正确配置该插件后，默认主题会把搜索框添加到导航栏。</p><p>该插件不一定能在其他主题中直接使用，因此你应参考主题本身的文档来获取更多信息。</p></div><h2 id="使用方法" tabindex="-1"><a class="header-anchor" href="#使用方法" aria-hidden="true">#</a> 使用方法</h2><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">npm</span> i <span class="token parameter variable">-D</span> @vuepress/plugin-search@next
