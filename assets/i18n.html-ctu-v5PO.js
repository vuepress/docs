import{_ as l}from"./plugin-vue_export-helper-x3n3nnut.js";import{r as i,o as c,c as r,a as n,b as s,d as e,w as p,e as a}from"./app-dDmHkibj.js";const d={},u=a(`<h1 id="i18n" tabindex="-1"><a class="header-anchor" href="#i18n"><span>I18n</span></a></h1><h2 id="site-i18n-config" tabindex="-1"><a class="header-anchor" href="#site-i18n-config"><span>Site I18n Config</span></a></h2><p>To take advantage of multi-language support in VuePress, you first need to use the following file and directory structure:</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>docs
├─ README.md
├─ foo.md
├─ nested
│  └─ README.md
└─ zh
   ...
   └─ nested
      └─ README.md
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),v=n("code",null,"locales",-1),m=a(`<div class="language-typescript line-numbers-mode" data-ext="ts" data-title="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),g={class:"hint-container tip"},b=n("p",{class:"hint-container-title"},"Tips",-1),_=n("p",null,"Config reference:",-1),y={href:"https://ecosystem.vuejs.press/themes/default/config.html",target:"_blank",rel:"noopener noreferrer"},x={href:"https://ecosystem.vuejs.press/themes/default/locale.html",target:"_blank",rel:"noopener noreferrer"};function w(E,T){const t=i("RouterLink"),o=i("ExternalLinkIcon");return c(),r("div",null,[u,n("p",null,[s("Then, specify the "),v,s(" option in your "),e(t,{to:"/guide/configuration.html#config-file"},{default:p(()=>[s("config file")]),_:1}),s(":")]),m,n("div",k,[h,n("p",null,[s("Config reference: "),e(t,{to:"/reference/config.html#locales"},{default:p(()=>[s("locales")]),_:1})])]),f,n("div",g,[b,_,n("ul",null,[n("li",null,[n("a",y,[s("Default Theme > Config"),e(o)])]),n("li",null,[n("a",x,[s("Default Theme > Locale config"),e(o)])])])])])}const I=l(d,[["render",w],["__file","i18n.html.vue"]]);export{I as default};
