...
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1);function C(N,V){const o=t("NpmBadge"),d=t("RouterLink"),r=t("CodeTabs");return u(),v("div",null,[b,a(o,{package:"@vuepress/theme-default"}),g,n("ul",null,[n("li",null,[k,n("ul",null,[h,_,f,w,n("li",null,[a(d,{to:"/zh/reference/default-theme/components.html#codegroup"},{default:e(()=>[s("CodeGroup")]),_:1}),s(" 和 "),a(d,{to:"/zh/reference/default-theme/components.html#codegroupitem"},{default:e(()=>[s("CodeGroupItem")]),_:1}),s(" 的别名： "),y])])]),x]),B,a(r,{id:"129",data:[{id:"FOO"},{id:"BAR"}]},{title0:e(({value:i,isActive:l})=>[s("FOO")]),title1:e(({value:i,isActive:l})=>[s("BAR")]),tab0:e(({value:i,isActive:l})=>[O]),tab1:e(({value:i,isActive:l})=>[A]),_:1})])}const P=p(m,[["render",C],["__file","markdown.html.vue"]]);export{P as default};
